...
To access the `.RData` file containing the dataset used in this analysis, please reach out to the dataset from following link. 

[Reach out for the .RData file](https://github.com/emu-hacettepe-analytics/emu660-spring2024-cevateness/blob/main/dataset)
