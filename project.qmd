...
The data source is Türkiye İstatistik Kurumu (Turkish Statistical Institute - TÜİK) database, which provides comprehensive and reliable statistical data for Turkey.
