...
To access the `.RData` folder containing the dataset used in this analysis, please reach out to the dataset from following link. 

[Reach out for the .RData folder](https://github.com/emu-hacettepe-analytics/emu660-spring2024-cevateness/blob/main/dataset)
...
These preprocessing steps were essential to transform the dataset into a clean, structured format suitable for detailed analysis.
